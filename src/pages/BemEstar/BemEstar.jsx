      ...
      <div className="bem-estar-content">
        ...
        >
          <section className="bem-estar-card">
            <header>
              ...
              <div>
                ...
                <p>
                  Toque na opção que representa
                  melhor como você se sente.
                </p>
              </div>
            </header>
          ...
          <section className="bem-estar-card">
            <header>
              ...
              <div>
                ...
                <p>
                  Você pode escolher mais de
                  uma opção ou nenhuma.
                </p>
              </div>
            </header>

            <div className="bem-estar-tags">
              {discomfortOptions.map(
                (option) => (
                  <button
                    key={option}
                    type="button"
                    className={
                      selectedDiscomforts.includes(
                        option,
                      )
                        ? "selected"
                        : ""
          ...
          <section className="bem-estar-card">
            ...
            <small className="bem-estar-counter">
              {note.length}/500
            </small>
          </section>

          <button
            className="bem-estar-save"
            type="submit"
          >
