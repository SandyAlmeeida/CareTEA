    ...
    <div className="caretea-cadastro-page">
      <main className="cadastro-shell">
        ...
        <section className="cadastro-content-grid">
          <FormsPresentation descricao={"Crie sua conta para começar a organizar os cuidados, promover a autonomia e apoiar a jornada de pessoas autistas e seus responsáveis."} />
