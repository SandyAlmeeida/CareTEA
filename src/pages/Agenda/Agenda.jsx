  ...
  const titulo = useMemo(
    () => {
      ...
      if (
        ...
        return `${fmtDiaCurto.format(
          ini,
        )} a ${fmtDiaCurto.format(
          fim,
        )} de ${ref.getFullYear()}`;
      }
          ...
          return (
            ...
            >
              <button
                ...
                aria-label={`Ver ${fmtDiaLongo.format(
                  dia,
                )}`}
              >
                {dia.getDate()}
    ...
    >
      ...
      >
        <div className="modal-head">
          <span
            className={`modal-icon icon-${t.cor}`}
          >
            {t.icon}
          </span>
