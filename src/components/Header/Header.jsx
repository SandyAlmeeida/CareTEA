    ...
    <div className="landing-header-shell">
      <header className="landing-header">
        ...
        <div className="landing-header-container">
          <a href="/" className="landing-header-logo">
            <img src={logoCaretea} alt="CareTEA" />
          </a>

          <nav className="landing-header-nav" aria-label="Navegação principal">
          ...
          <div className="landing-header-actions">
            <Link to="/login" className="landing-header-button landing-login-button">
              Entrar
            </Link>

            <Link to="/cadastro" className="landing-header-button landing-register-button">
              Cadastrar-se
            </Link>
